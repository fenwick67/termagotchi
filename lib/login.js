...
module.exports = function(args,done){
  ...
  function gistSetup(){
    p.prompt(
      [ '(just enter "Q" at any time and hit "Enter" to quit)',
        ...
        '',
        "(this is an open source project.  If you don't trust the author, you can read the code yourself at https://github.com/fenwick67/termagotchi)",
        ''
      ].join('\n'),gotPat
    )
  }
    ...
    client.getUser().listGists(function(er,gists){
      if (er){
        ...
        if (!termaGist){// no gist yet.  Create one.
          ...
          gistManager.createTermaGist(termaState,function(er,id){
           if (er){
